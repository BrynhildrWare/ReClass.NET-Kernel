...
#define IO_READ_REQUEST CTL_CODE(FILE_DEVICE_UNKNOWN, 0x133701, METHOD_BUFFERED, FILE_SPECIAL_ACCESS)
#define IO_WRITE_REQUEST CTL_CODE(FILE_DEVICE_UNKNOWN, 0x133702, METHOD_BUFFERED, FILE_SPECIAL_ACCESS)
#define IO_PROCESS_INFO CTL_CODE(FILE_DEVICE_UNKNOWN, 0x133703, METHOD_BUFFERED, FILE_SPECIAL_ACCESS)
